...
extension MenuViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == groupsCollectionView{
            ...
            let products = self.group.groups![indexPath.item].prouct!
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if collectionView == groupsCollectionView{
            ...
            let width = groupName.widthOfString(usingFont: UIFont.systemFont(ofSize: 25))
...
let stotyboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = stotyboard.instantiateViewController(identifier: "FullProductViewController ") as! FullProductViewController
